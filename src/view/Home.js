...
import { LoadMarketplaceItems, BuyMarketItem, SkipSong } from '../controller/HomeControl.js';
...
function Home({ contract }) {
  ...
  const stateMethods = [contract, audioRef, loading, setLoading, isPlaying, setIsPlaying, currentItemIndex, setCurrentItemIndex, marketItems, setMarketItems];
  ...
  useEffect( () => !marketItems && LoadMarketplaceItems(stateMethods) )
              ...
              <Card>
                ...
                <Card.Body color="secondary">
                  ...
                  <div className="d-grid px-4">
                    <ButtonGroup size="lg" aria-label="Basic example">
                      <Button variant="secondary" onClick={() => SkipSong(stateMethods, false)}>
                      ...
                      <Button variant="secondary" onClick={() => SkipSong(stateMethods, true)}>
                ...
                <Card.Footer>
                  <div className='d-grid my-1'>
                    <Button onClick={() => BuyMarketItem(stateMethods, marketItems[currentItemIndex])} variant="primary" size="lg">
