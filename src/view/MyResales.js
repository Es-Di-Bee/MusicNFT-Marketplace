...
import {LoadResales} from '../controller/MyResalesControl.js'
...
function MyResales({ contract, account }) {
  ...
  const stateMethods = [contract, account, audioRefs, loading, setLoading, listedItems, setListedItems, soldItems, setSoldItems, isPlaying, 
  setIsPlaying, selected, setSelected, previous, setPrevious];
  ...
  useEffect(() => !listedItems && LoadResales(stateMethods))
          ...
          <div className="px-5 py-3 container">
            ...
            <>
              ...
              {soldItems.length > 0 ?
                ...
                : (
                  <main style={{ padding: "1rem 0" }}>
                    <h2 style={{fontSize:'100%'}}>No sold assets</h2>
                  </main>
                )}
            </>
          </div>
